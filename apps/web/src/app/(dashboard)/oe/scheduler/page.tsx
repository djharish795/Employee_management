  ...
  return (
    <div className="p-6 md:p-8 max-w-[1600px] mx-auto animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">OE Meeting Scheduler</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage your OE client consultations and upcoming strategy sessions.</p>
        </div>
