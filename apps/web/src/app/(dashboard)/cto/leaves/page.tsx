...
import { Search, Info, ChevronLeft, ChevronRight, Plus, Lock } from 'lucide-react';
        ...
        <div className="space-y-4">
          {requests.length === 0 ? (
            <div className="bg-white border border-slate-200 rounded-xl p-12 text-center shadow-sm">
              ...
              <p className="text-sm font-medium text-slate-500">Waiting for backend data for {activeTab} requests...</p>
            </div>
          ) : (
            // Cards would go here
            null
              ...
              <tbody>
                <tr>
                  <td colSpan={32} className="py-12 text-center text-slate-400 font-medium">
                    Waiting for backend calendar data...
                  </td>
                </tr>
              </tbody>
            </table>
