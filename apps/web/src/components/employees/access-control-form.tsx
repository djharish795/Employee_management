...
import { User, Shield, Grid, ShieldCheck, RefreshCw, Info } from 'lucide-react';
        ...
        <Card className="border-slate-200 shadow-sm rounded-xl">
          ...
          <CardContent>
            ...
            <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-xl p-4 mb-5">
              ...
              <div>
                <p className="text-sm font-bold text-blue-800 mb-1">Credentials are auto-generated</p>
                <p className="text-xs text-blue-700 leading-relaxed">
                  A secure temporary password will be automatically generated by the system when onboarding is completed.
                  Login credentials will be sent directly to the employee's <strong>official email address</strong> from Step 1.
                  The employee must change their password on first login.
                </p>
              </div>
            </div>

            {/* Role Assignment — the only thing HR controls here */}
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-slate-700">System Role <span className="text-red-500">*</span></label>
              <select
                name="role"
                value={role}
              ...
              >
                ...
                <option value="EMPLOYEE">Employee — Standard access (Attendance, Leaves, Profile)</option>
                <option value="MANAGER">Manager — Team management + approvals</option>
                <option value="TEAM_LEAD">Team Lead — Project & task management</option>
                <option value="HR">HR — Full HR & onboarding access</option>
                <option value="FINANCE">Finance — Payroll & financial access</option>
                <option value="IT">IT — Asset & infrastructure management</option>
                <option value="CHRO">CHRO — Full HR executive access</option>
              </select>
              <p className="text-xs text-slate-400 mt-1">This determines what the employee can see and do inside the EMS.</p>
            </div>
          </CardContent>
        </Card>
