...
export function Sidebar() {
  ...
  return (
    <aside className="w-[260px] flex-shrink-0 bg-[#0F172A] flex flex-col h-screen text-slate-300 overflow-y-auto overflow-x-hidden border-r border-slate-800 scrollbar-hide">
      {/* Brand Header */}
      <div className="p-6 pb-4">
        <h2 className="text-xl font-bold text-white tracking-tight">Naprocs CEO</h2>
        <p className="text-xs text-slate-400 font-medium tracking-wide mt-0.5">Executive Dashboard</p>
      </div>
      ...
      <div className="p-4 mt-auto">
        <button className="flex items-center gap-3 px-3 py-2.5 w-full text-left rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-800/50 hover:text-white transition-colors">
