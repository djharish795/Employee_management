...
const CATEGORY_DISTRIBUTION = [
  { label: "Laptops", count: 154, percent: 82, color: "bg-blue-600" },
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-4">
                {(categoryKpis || CATEGORY_DISTRIBUTION).map((cat: any, idx: number) => {
                  ...
                  const colors = ["bg-blue-600", "bg-slate-700", "bg-emerald-500", "bg-amber-500", "bg-sky-500", "bg-rose-500", "bg-slate-400"];
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
            ...
            <div className="flex flex-col gap-2.5">
              <Link
                href="/assets/requests"
                className="flex items-center justify-center gap-2 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-lg transition-colors shadow-sm"
              >
