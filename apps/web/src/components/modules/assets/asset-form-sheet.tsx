        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border rounded-lg outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border rounded-lg outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400 bg-white"
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-3 py-2 text-sm border rounded-lg outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400 resize-none"
          ...
          <DialogFooter className="mt-6 pt-4 border-t">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-bold text-white bg-violet-600 rounded-lg hover:bg-violet-700 disabled:opacity-50 transition-colors"
            >
