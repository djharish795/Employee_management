  ...
  return (
    <div className="p-6 md:p-8 max-w-[1600px] mx-auto animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Operations Scheduler</h1>
          <p className="text-slate-500 mt-1">Manage field syncs, team meetings, and operations reviews.</p>
        </div>
      </div>
            ...
            <div className="p-4 space-y-4">
              <div>
                ...
                <input 
                  ...
                  placeholder="e.g. Field Ops Sync" 
                  disabled={createMeetMutation.isPending}
                />
              </div>
              <div>
