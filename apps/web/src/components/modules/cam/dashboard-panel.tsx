  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto w-full font-sans pb-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Today's Work</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col justify-between hover:border-slate-300 transition-all">
          <div className="flex justify-between items-start mb-4">
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider leading-tight w-24">
              New Leads Assigned
            </span>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            <div className="px-6 py-5 flex items-center justify-between border-b border-slate-100">
              <h2 className="text-base font-black text-slate-900">Action Required</h2>
              <div className="relative">
                <div className="flex items-center gap-1.5 text-xs font-bold text-slate-500">
                  <span>FILTER BY:</span>
                  <button 
                    onClick={() => setShowFilterDropdown(!showFilterDropdown)}
                    className="text-slate-900 font-extrabold flex items-center gap-1 hover:text-slate-700 transition-colors uppercase"
                  >
            ...
            <div className="py-4 text-center border-t border-slate-100 bg-slate-50/30">
              <button className="inline-flex items-center gap-1 text-xs font-black uppercase tracking-widest text-slate-500 hover:text-slate-800 transition-colors">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 text-xs font-semibold text-slate-800">
                  ...
                  <tr className="hover:bg-slate-50/80 transition-colors">
                    <td className="py-4 px-6">
                      <div className="font-bold text-slate-950">Horizon Ventures</div>
                    ...
                    <td className="py-4 px-6 text-right">
                      <button className="px-4 py-1.5 text-[10px] font-black tracking-widest uppercase text-white bg-slate-950 rounded-lg hover:bg-slate-800 transition-colors shadow-sm">
                        Join
                      </button>
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/80 transition-colors">
                    <td className="py-4 px-6">
                      <div className="font-bold text-slate-950">Kinetix Group</div>
                    ...
                    <td className="py-4 px-3">
                      <span className="inline-block px-2.5 py-0.5 bg-slate-50 text-slate-600 border border-slate-200 rounded text-[9px] font-black uppercase tracking-wider">
                        Pending Prep
                      </span>
                    </td>
                    <td className="py-4 px-6 text-right">
                      <button className="px-4 py-1.5 text-[10px] font-black tracking-widest uppercase text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors shadow-sm">
                        Prepare
                      </button>
                    </td>
                  </tr>
            ...
            <div className="space-y-3">
              ...
              <div className="border border-slate-200 rounded-xl p-4 flex flex-col gap-3 hover:border-slate-300 transition-all bg-white">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-wider text-slate-400 bg-slate-50 px-2 py-0.5 rounded border border-slate-200">
                    Med
                  </span>
                </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 space-y-4">
            ...
            <div className="relative pl-2 border-l border-slate-100 ml-2.5 space-y-6 py-2">
              ...
              <div className="relative pl-6">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-700 leading-snug">
                    New lead <span className="text-slate-950 font-extrabold">'Titan Dynamics'</span> assigned via Automation
                  </p>
              ...
              <div className="relative pl-6">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-700 leading-snug">
                    Lead <span className="text-slate-950 font-extrabold">'Elena Markova'</span> marked as Qualified
                  </p>
                  <span className="inline-block text-[10px] font-medium text-slate-400 mt-1">
                    10:05 AM
                  </span>
